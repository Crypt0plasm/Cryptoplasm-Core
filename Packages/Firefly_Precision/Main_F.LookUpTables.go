...
//
// is used to map binary digit counts to their corresponding
...
//=================================================================================================
//
// Function 00a - First init function
//
//================================================
func init() {
	curVal := big.NewInt(1)
...
//================================================
//
// Function 01 - NumDigits
//
// Returns the number of decimal digits of b.
//================================================
...
//=================================================================================================
//
// Function 00b - Second init function
//
//================================================
func init() {
	tmpInt := new(big.Int)
...
// PART III - tableExp10
//
// returns 10^x for x >= 0, looked up from a table when
