...
func DrawUnitySVG(Day string, TxTaxAddy, Winner b.ElrondAddress) (*svg.SVG, []Rectangle) {
	...
	//3f)Draw Rectangles
	Rectangles[0] = PrimaryUpperRectangle
	Rectangles[1] = SecondaryUpperRectangle
	Rectangles[2] = PrimaryMiddleRectangle
	Rectangles[3] = SecondaryMiddleRectangle
	Rectangles[4] = PrimaryLowerRectangle
	Rectangles[5] = SecondaryLowerRectangle
	Rectangles[6] = MintingPowerRectangle
	Rectangles[7] = NodeRectangle
