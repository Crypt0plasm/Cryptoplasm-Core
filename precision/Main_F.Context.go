...
//=================================================================================================
//=================================================================================================
// All Cryptoplasm_Firefly_Precision Primary Context Functions are listed below:
//=================================================================================================
//
// Function 01 - Abs
//
// sets d to |x| (the absolute value of x).
...
// Function 04 - Ceil
//
// sets d to the smallest integer >= x.
...
// Function 07 - Floor
//
// sets d to the largest integer <= x.
...
// Function 09 - Log10
//
// sets d to the base 10 log of x.
func (c *Context) Log10(d, x *Decimal) (Condition, error) {
	if set, res, err := c.logSpecials(d, x); set {
		return res, err
	}

	//This is exact under some conditions.
	res := Inexact
...
//
// creates a new decimal from s. The returned Decimal has its
...
//
// adjusts and rounds x as necessary so it is represented with
...
// Function 15 - Quo
//
// sets d to the quotient x/y for y != 0. c.Precision must be > 0. If an
...
//
// sets d to the integer part of the quotient x/y. If the result
...
// Function 17 - Reduce
//
// sets d to x with all trailing zeros removed and returns the number
// of zeros removed.
...
// Function 18 - Rem
//
// sets d to the remainder part of the quotient x/y. If
...
// Function 19 - Round
//
// sets d to rounded x, rounded to the precision specified by c. If c
...
//
// sets d to integral value of x. Inexact and Rounded flags
...
//
// sets d to s and returns d. The returned Decimal has its exponents
...
// Function 23 - Sqrt
//
// sets d to the square root of x. Sqrt uses the Babylonian method
...
//
// returns a copy of c but with the specified precision.
...
//================================================
//
// Function 01 - setIfNan
//
// setIfNaN sets d to the first NaNSignaling, or otherwise first NaN, of
// input values. d' is unchanged if the values contains no NaNs.
//True is returned if d was set to a NaN.
